...
Future<void> compartirDepositoPdf(
  ...
  final path = '${directory.path}/comprobante_deposito.pdf';
  ...
  await Share.shareFiles([path], text: 'Compartiendo comprobante de depósito');
}
